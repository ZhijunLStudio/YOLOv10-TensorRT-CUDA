...
def concatenate_images_with_spacing(img1_path, img2_path, output_path, spacing=50):
    ...
    cv2.putText(concatenated_img, 'yolov10原始', (width1 // 2 - 100, y_offset), font, font_scale, font_color, thickness)
    cv2.putText(concatenated_img, 'yolov10推理', (width1 + spacing + width2 // 2 - 100, y_offset), font, font_scale, font_color, thickness)

    # 保存拼接后的图片
    cv2.imwrite(output_path, concatenated_img)

if __name__ == "__main__":
    img1_path = 'path/to/your/first/image.jpg'
    img2_path = 'path/to/your/second/image.jpg'
    output_path = 'path/to/save/concatenated/image.jpg'
