...
void save_input_buffer(float* input_buffer_device, int width, int height, cudaStream_t stream, std::string filename = "preprocessed_image.png") {
    // 在CPU上分配内存
    ...
    // OpenCV保存图片
    cv::imwrite("preprocessed_image.png", img * 255.0); // 乘以255.0是因为数据范围在0-1之间
